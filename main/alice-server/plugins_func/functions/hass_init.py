...
def append_devices_to_prompt(conn):
    if conn.intent_type == "function_call":
        ...
        # Safely retrieve the plugin configuration.
        ...
        if "hass_get_state" in funcs or "hass_set_state" in funcs:
            prompt = "\nHere is the list of smart devices in my home (location, device name, entity_id), which can be controlled through Home Assistant.\n"
...
def initialize_hass_handler(conn):
    ...
    # Retrieve the configuration uniformly.
