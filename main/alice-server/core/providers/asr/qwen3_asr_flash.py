...
class ASRProvider(ASRProviderBase):
    def __init__(self, config: dict, delete_audio_file: bool):
        ...
        """Initialize the Qwen3-ASR-Flash ASR provider."""
        
        # Configuration parameters.
        self.api_key = config.get("api_key")
        if not self.api_key:
            raise ValueError("Qwen3-ASR-Flash requires an api_key to be configured")
        ...
        self.language = config.get("language", None)  # Specify the language; defaults to automatic detection
    ...
    async def speech_to_text(
        ...
        try:
            ...
            # If context information is present, add a system message.
            if self.context:
                messages.insert(0, {
                    "role": "system", 
                    "content": [
            ...
            for chunk in response:
                try:
                    ...
                    # Update the latest complete text.
