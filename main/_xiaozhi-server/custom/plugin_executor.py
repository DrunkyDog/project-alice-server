...
class ServerPluginExecutor(ToolExecutor):
    ...
    def get_tools(self) -> Dict[str, ToolDefinition]:
        ...
        # 获取必要的函数
        necessary_functions = ["handle_exit_intent", "get_lunar", "get_directions", "calendar_create_event", "calendar_search_events", "calendar_delete_event", "calendar_update_event"]
