export default {
  ...
  // Hardcoded Chinese strings from components
  'common.cancel': 'Cancel',
  'common.confirmSave': 'Confirm Save',
  'common.select': 'Select',
  'common.action': 'Action',
  'common.loading': 'Loading...',
  'common.clearSelectionFailed': 'Clear selection failed:',
  'common.logoutFailed': 'Logout failed:',
  'common.copyFailed': 'Copy failed:',
  'common.copyFailedManual': 'Copy failed, please copy manually',
  'common.getMcpAddressFailed': 'Failed to get MCP address:',
  'common.getMcpToolListFailed': 'Failed to get MCP tool list:',
  'common.enterValidJson': 'Please enter valid JSON',
  'common.unknownSpeaker': 'Unknown Speaker',
  'common.whatTimeIsIt': 'What time is it now.',
  'common.apiKey': 'API Key',
  'common.personalAccessToken': 'Personal Access Token',
  'common.token': 'Token',
  'common.key': 'Key',
  'common.sensitiveInfo': 'Sensitive Information',
  'common.accessToken': 'Access Token',
  'common.accessKey': 'Access Key',
  'common.arrayFormatError': 'Array format error, must end with English semicolon',
  'common.addParam': 'Add Parameter',
  'common.addReplacementWord': 'Add Replacement Word',
  'common.addSpeaker': 'Add Speaker',
  'common.enterName': 'Please enter name',
  'common.enterDescription': 'Please enter description',
  'common.selectAudioVector': 'Please select audio vector',
  'common.loadingRagModelList': 'Starting to load RAG model list',
  'common.ragModelListLoaded': 'RAG model list loaded successfully, total',
  'common.models': 'models',
  'common.setDefaultRagModel': 'Set default RAG model:',
  'common.getRagModelListFailed': 'Failed to get RAG model list:',
  'common.getFirmwareTypeFailed': 'Failed to get firmware type:',
  'common.beianIcon': 'Beian Icon',
  'common.deletionCancelled': 'Deletion cancelled',
  'common.loadFailed': 'Load failed:',
  'common.operationFailed': 'Operation failed:',
  'common.uploadAudioFailed': 'Upload audio failed:',
  'common.jsonFormatError': 'JSON format error (such as {',
  'common.dictionaryFormatError': 'Must enter dictionary format (such as {',
  'common.saveAsOriginal': '}), save to use original data',
