...
class ASRProvider(ASRProviderBase):
        ...
        try:
            ...
            async with websockets.connect(
                ...
                if (
                    ...
                    and result["payload_msg"]["code"] != 1013  # Ignore errors for no valid speech
                ):
                ...
                if (
                    ...
                    # No valid speech; return an empty string.
                    return ""
                else:
                    logger.bind(tag=TAG).error(f"ASR error: {result}")
                    return None
    ...
    async def speech_to_text(
        ...
        try:
            ...
            # Use the PCM data directly.
            # Calculate the segment size (mono, 16-bit, 16 kHz sample rate).
