...
class ContextDataProvider:
    """Data context provider, responsible for fetching data from configured API"""
    ...
    def fetch_all(self, device_id: str) -> str:
        ...
        for provider in context_providers:
            ...
            try:
                ...
                # Add device_id to request headers
                ...
                if response.status_code == 200:
                    ...
                    if isinstance(result, dict):
                        ...
                        self.logger.bind(tag=TAG).warning(f"API {url} did not return a JSON dictionary")
                else:
