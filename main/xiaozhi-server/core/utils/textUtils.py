...
def get_string_no_punctuation_or_emoji(s):
    """Remove leading/trailing spaces, punctuation marks, and emojis from string"""
    chars = list(s)
...
def is_punctuation_or_emoji(char):
    ...
    # Define Chinese and English punctuation to remove (including full-width/half-width)
    punctuation_set = {
        "，",
