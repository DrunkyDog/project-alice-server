...
print("Please prepare the configuration according to the instructions in doc/performance_testerer.md before use.")
...
def main():
    ...
    try:
        choice = int(input("Please select the performance testing tool number:")) - 1
